...
export function TransactionsOverviewCard({ isVerp = false }: { isVerp?: boolean }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className={isVerp ? "font-normal text-foreground" : "font-normal"}>{isVerp ? "Revenue Overview" : "Spending Overview"}</CardTitle>
        <CardAction>
