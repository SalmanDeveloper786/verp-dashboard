...
export function BalanceDistributionCard({ isVerp = false }: { isVerp?: boolean }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className={isVerp ? "font-normal text-foreground" : "font-normal"}>{isVerp ? "Fund Flow Overview" : "Account Allocation"}</CardTitle>
        <CardAction>
