...
export const THEME_PRESET_OPTIONS = [
  ...
  },
  {
    ...
    value: "clinic-blue",
    primary: {
      light: "oklch(0.60 0.18 250)",
      dark: "oklch(0.65 0.18 250)",
    },
  },
  {
    label: "Pharmacy Teal",
    value: "pharmacy-teal",
    primary: {
      light: "oklch(0.60 0.15 175)",
      dark: "oklch(0.65 0.15 175)",
    },
  },
  {
    label: "Healthcare Slate",
    value: "healthcare-slate",
    primary: {
      light: "oklch(0.50 0.05 230)",
      dark: "oklch(0.65 0.05 230)",
    },
  },
] as const;
